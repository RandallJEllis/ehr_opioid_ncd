    ...
    for followup_interval in [5, 10]:
        ...
        for ncd_thresh in [45,55,65]:
            ...
            if os.path.isfile(f'{output_path}/populations/voe_{beg_year}_{end_year}_{followup_interval}yearfollowup_{ncd_thresh}NCDageExclusion.csv'):
                ...
                scalar_con_mean_age, scalar_aud_mean_age, scalar_con_sd_age, scalar_aud_sd_age, scalar_con_perc_male, \
                    scalar_aud_perc_male, scalar_con_perc_female, scalar_aud_perc_female = mean_sd_age_percent_sex(end_year, control_cohort, aud_cohort)
