                                        ...
                                        for hx_sud_covar in [0,1]:
                                            for num_recs_covar in [0,1]:
                                                ...
                                                if c>1:
                                                    ...
                                                    df.to_csv(f'voe_outputs/AUD/voe_{beg_year}_{end_year}_{numrecsthreshold}OrMoreRecs.csv', index=None)
                                                ...
                                                fifi.to_csv(f'voe_outputs/AUD/voe_{beg_year}_{end_year}_{numrecsthreshold}OrMoreRecs_{c}.csv')
