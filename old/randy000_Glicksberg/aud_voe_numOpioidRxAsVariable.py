...
sud_icd = sud_icd[~sud_icd.ONTOLOGY_ID.isin([303.02, 303.03, 303.9, 303.01, 303.0, 303.91, 303.92, 303.93, 305.0, 305.02, 305.03, 305.01,'F10.10','F10.120','F10.121','F10.129','F10.14', 'F10.180', 'F10.19',
                                            ...
                                            for num_recs_covar in [0,1]:
                                                for oprx in [0,1]:
                                                    ...
                                                    if c>1:
                                                        ...
                                                        df.to_csv(f'voe_outputs/AUD/OPIOIDRX_voe_{beg_year}_{end_year}_{numrecsthreshold}OrMoreRecs.csv', index=None)
                                                    ...
                                                    fifi.to_csv(f'voe_outputs/AUD/OPIOIDRX_voe_{beg_year}_{end_year}_{numrecsthreshold}OrMoreRecs_{c}.csv')
