...
output_path = '../voe_outputs/OUD/controlsNoOpioidsDuringEnrollment/'
...
for beg_year,end_year in zip([2006,2007,2008,2009,2010,2011,2012,2013,2014],
    ...
    c, control_N, opioid_N, control_mean_age, opioid_mean_age, control_sd_age, opioid_sd_age, control_perc_male, opioid_perc_male, control_perc_female,\
         opioid_perc_female, coefs, ps, low_interval, high_interval, num_control_ncd, num_opioid_ncd, followup_interval_col, beg_year_col, end_year_col,\
    ...
    for followup_interval in [5, 10]:
        ...
        begin, end, followup, mrn_opioid_counts, mrn_opioids = opioid_prescriptions(opi_prescrip, beg_year, end_year, followup_interval)
        ...
        for num_op in [5, 10, 15]:
            ...
            opioid_cohort_mrns = opioid_enrollment(num_op, mrn_opioid_counts, mrn_opioids)
            ...
            for ncd_thresh in [45,55,65]:
                ...
                pop = build_population(sickle_icd_fu_mrns, hepc_icd_fu_mrns, hiv_icd_fu_mrns, aud_icd_fu_mrns, sud_icd_fu_mrns, depression_icd_fu_mrns,\
                     anxiety_icd_fu_mrns, ncd_followup, control_cohort, opioid_cohort)
                ...
                #save population
                pop.to_csv(f'../voe_outputs/OUD/controlsNoOpioidsDuringEnrollment/populations/OPIOIDRX_voe_{beg_year}_{end_year}_{followup_interval}yearfollowup_{num_op}OpioidsEnrollment_{ncd_thresh}NCDageExclusion_{c}.csv')   
                                            ...
                                            for hx_mat in [0,1]:
                                                ...
                                                update_results_csv(beg_year, end_year, c, control_N, opioid_N, control_mean_age, opioid_mean_age, \
                                                    control_sd_age, opioid_sd_age, control_perc_male, opioid_perc_male, control_perc_female, \
                                                        opioid_perc_female, coefs, ps, low_interval, high_interval, num_control_ncd, num_opioid_ncd,\
                                                             followup_interval_col, beg_year_col, end_year_col, num_op_col, ncd_thresh_col, hx_sickle_col,\
                                                                 hx_hepc_col, hx_hiv_col, hx_aud_col, hx_sud_covar_col, hx_depression_col, hx_anxiety_col,\
                                                                     hx_mat_col)
                                                
                                                #set up statistical model
                                                formula = statistical_model(hx_sickle, hx_hepc, hx_hiv, hx_aud, hx_sud_covar, hx_depression, hx_anxiety, hx_mat, opioid_predictor='binary_exposure')
                                                                    ...
                                                                    hx_mat_col, followup_interval, num_op, ncd_thresh, control_cohort, opioid_cohort, \
                                                                        scalar_con_mean_age, scalar_opi_mean_age, scalar_con_sd_age, scalar_opi_sd_age,\
                                                                             scalar_con_perc_male, scalar_opi_perc_male, scalar_con_perc_female,\
                                                                                 scalar_opi_perc_female, pop, hx_sickle, hx_hepc, hx_hiv, hx_aud,\
                                                                                     hx_sud_covar, hx_depression, hx_anxiety, hx_mat, res)
    ...
    export_final_data_enrollment_period(new_line, beg_year, end_year, c, control_N, opioid_N, control_mean_age, opioid_mean_age, control_sd_age,\
         opioid_sd_age, control_perc_male, opioid_perc_male, control_perc_female, opioid_perc_female, coefs, ps, low_interval, high_interval, \
            num_control_ncd, num_opioid_ncd, followup_interval_col, beg_year_col, end_year_col, num_op_col, ncd_thresh_col, hx_sickle_col, hx_hepc_col, \
                hx_hiv_col, hx_aud_col, hx_sud_covar_col, hx_depression_col, hx_anxiety_col, hx_mat_col)
